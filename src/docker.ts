 ...
 */
export function execDocker(args: string[], input?: Uint8Array, dockerCommand = 'docker'): Promise<DockerExecResult> {
	return new Promise((resolve, reject) => {
		const child = cp.spawn(dockerCommand, args, { stdio: ['pipe', 'pipe', 'pipe'] });
